...
const filePath = 'attached_assets/제휴_업체_완료_통합_1110개_3_1762188978729.xlsx';
  ...
  try {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      try {
        ...
        const benefitContentRaw = row['제휴 내용'];
        const benefitContent = benefitContentRaw ? String(benefitContentRaw) : '';
